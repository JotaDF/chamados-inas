<?php
        ...
        foreach ($prestador->contratos as $obj) {
            ...
            if($usuario_logado->perfil <= 2 || $obj->editor == 1){
                ...
                $btn_editar = '&nbsp;&nbsp;<button title="Editar" class="btn btn-primary btn-sm" type="button" onclick="alterar('.$obj->id.',\''.$obj->numero.'\','.$obj->valor.','.$obj->ano.','.$obj->vigente.','.$prestador->id.')"><i class="fa fa-edit</button>';
                if($obj->excluir){
