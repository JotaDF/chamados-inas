                            ...
                            <div class="card-body bg-gradient-primary" style="min-height: 5.0rem;">
                                <div class="row">
                                    <div class="col c2 ml-2">
                                        <div class="h6 text-xs text-white font-weight-bold text-uppercase mb-1">Chamado
                                        </div>
                                        <div class="h5 mb-0 text-white font-weight-bold">
                                            [<small><?= $chamado->id ?></small>]
                                            <?= $categoria->nome ?>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        ...
                                        if ($usuario_logado->id == $chamado->usuario || $usuario_logado->perfil <= 2 || $usuario_logado->perfil == 9) {
                                            ...
                                            if ($chamado->status == 2) {
                                                ...
                                                <button class="btn btn-warning btn-sm" type="button"
                                                    onclick="reabrir('<?= $chamado->id ?>','<?= $usuario->nome ?>','<?= $chamado->descricao ?>','<?= $usuario_logado->id ?>')">
