    ...
    <div class="card mb-4 border-primary" style="width: 56rem;">
        ...
        <div class="card-body">
            <form action="save_quest_pergunta.php" method="POST">
                ...
                <div class="row mb-3">
                    <label for="colFormLabelSm"
                        class="col-sm-2 col-form-label col-form-label-sm"><strong>Opcional:</strong></label>
                    <div class="col-sm-7">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="opcional" id="opcional" value="1">
                            <label class="form-check-label" for="pergunta_sim">Sim</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="opcional" id="opcional" value="0">
                            <label class="form-check-label" for="pergunta_nao">Não</label>
                        </div>
                    </div>
