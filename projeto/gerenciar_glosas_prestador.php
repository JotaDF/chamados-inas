                                            ...
                                            $btn_nova = "<button id='btn_cadastrar' align='center' onclick='novaNota(".$obj->id.",\"".$obj->carta_recursada."\",\"".$obj->valor_original."\")' title='Adicionar nota!' class='btn btn-primary btn-sm' type='button'>
                                                    ...
                                                    foreach ($notas as $n) {
                                                        ...
                                                        foreach($cartas as $c) {                                
                                                            ...
                                                            $btn_nt_reverter_atst = "<a class='btn btn-danger btn-sm' title='Reverter execução!' href='reverter_atesto_nota_glosa.php?id_prestador=".$prestador->id."&id=".$c->id."&id_usuario=".$usuario_logado->id."'><i class='fa fa-random'></i></a>&nbsp;";                                                    
                                                            $btn_nt_reverter_pag = "<a class='btn btn-danger btn-sm' title='Reverter execução!' href='reverter_pagamento_nota_glosa.php?id_prestador=".$prestador->id."&id=".$c->id."&id_usuario=".$usuario_logado->id."'><i class='fa fa-random'></i></a>&nbsp;";                                                    
