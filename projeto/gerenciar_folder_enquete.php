...
<html>
    <head>
        ...
        <title>Gerenciar folder enquete</title>
        ...
        <script type="text/javascript" class="init">
             function deleteFile(fileName) {
                ...
                xhr.open("GET", "del_arquivo_enquete.php?id=<?=$id ?>&file=" + fileName, true);
            ...
            function atualizar(){
                ...
                $.ajax({
                    url: 'get_folder_enquete.php?id=<?=$id ?>',
                    dataType: 'html',
                    success: function (html) {
                        $('#arquivos_enquete').html(html);
                    }
                });
            }
    ...
    <body id="page-top">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div style="max-width:900px" class="row float-none">
                        <div class="ml-3 mb-2">
                            <a href="enquetes.php" class="btn btn-success btn-sm"><i class="fa fa-arrow-left text-white"></i> Voltar</a>
                        </div>
                    </div>
                        <?php

                        $uploadDir = 'enquetes/folder_';
                        $uploadDir .= $id;
                        $uploadDir .= '/';
                        ?>
                        
                        <!-- Collapsable Form -->
                        <div class="card mb-4 collapse hide border-primary" id="form_arquivos_enquete" style="max-width:900px">
                            <!-- Card Header - Accordion -->
                            <div class="card-header py-2 card-body bg-gradient-primary align-middle" style="min-height: 2.5rem;">               
                                <span class="h6 m-0 font-weight text-white">Enviar arquivos da enquete (<?='folder_' . $id ?>)</span>
                            </div>                  
                            <!-- Card Content - Collapse -->
                            <div class="card-body">
                                <div class="card-group">
                                <div class="drop-section">Solte seu arquivo aqui</div>
                                <button class="file-selector-button">Buscar arquivo</button>
                            ...
                            <div class="form-group row float-right">
                                <button type="reset" data-toggle="collapse" data-target="#form_arquivos_enquete" class="btn btn-danger btn-sm"><i class="fa fa-minus-square"></i> Cancelar</button>
                            </div>
                        </div>
                        </div>
                            ...
                            <div class="card-body bg-gradient-primary" style="min-height: 5.0rem;">
                                <div class="row">
                                    <div class="col c2 ml-2">
                                        <div class="h5 mb-0 text-white font-weight-bold">Gerenciamento de folder da enquete</div>
                                    </div>
                                    <div class="col-auto">
                        ...
                        <div class="card mb-4 border-primary" style="max-width:900px">
                            <div class="row ml-0 card-header py-2 bg-gradient-primary" style="width:100%">
                                ...
                                <div class="col mb-0">
                                    <span style="align:left;" class="h5 m-0 font-weight text-white">Folder da enquete </span> <button class='btn btn-outline-light btn-sm' type='button' title="Atualizar lista!" onclick="atualizar()"><i class="fa fa-spinner text-white" aria-hidden="true"></i></button>
                                </div>
                                <div class="col text-right" style="max-width:20%">
                                    <button id="btn_cadastrar" class="btn btn-outline-light btn-sm" type="button" data-toggle="collapse" data-target="#form_arquivos_enquete" aria-expanded="false" aria-controls="form_arquivos_enquete">
                                        <i class="fa fa-plus-circle text-white" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>                            
                            <div class="card-body">
                                <div class="card-group" id="arquivos_enquete">
                                    <?php
        ...
        function addFileToList(file) {
            ...
            // Adiciona o enquete de clique ao botão de exclusão
            li.querySelector('.cross').onclick = () => removeFileFromList(file, li);

            // Adiciona o enquete de clique ao botão de envio individual
        ...
        function uploadFile(file, li) {
            ...
            data.append('id', '<?=$id ?>');
            http.open('POST', 'save_arquivo_enquete.php', true);
            http.send(data);
            atualizar();
        }
