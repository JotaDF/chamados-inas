<?php
	...
	$lista = $manterOficio->listar();
        ...
        foreach ($lista as $obj) {
            ...
            $btn_arquivo= '&nbsp;&nbsp;<a href="gerenciar_arquivo_oficio.php?id='.$obj->id.'" title="Gerenciar arquivo ofício" class="btn btn-warning btn-sm" type="button"><i class="fa fa-file-image"></i></a>';
