...
<html>
    <head>
        ...
        <title>GERENTE - Gerenciador de inscritos</title>
    ...
    <body id="page-top">
        ...
        ?>
        <!-- Begin Page Content -->
        <div id="containerUsuario" class="container-fluid align-items-center" style="width:95%">
            <!-- Content Row -->
            ...
            <div id="containerUsuario" role="main" class="align-items-center" style="width:100%"><h2 class="text-center">Inscritos para: <?=$evento->titulo ?><</h2><img src="img/iconexcel.png" width="30" height="30" class="d-print-none" id="btnExport" />
                    <table class="table table-striped" id="inscritos">
                        <tr class="thead-dark">
                            ...
                            <th class="header c2 text-nowrap text-center" style="" scope="col" style="width:50%"><i class="fa fa-minus-square text-white c4" onclick="naover('c4');" aria-hidden="true" title="Remover coluna"></i> REGISTRO </th>
                        </tr>
                        <?php
                        foreach ($inscritos as $obj) {
                            ?>
                            <tr class="">
