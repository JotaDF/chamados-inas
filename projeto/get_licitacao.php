<?php
	...
	$lista = $manterLicitacao->listar();
        ...
        foreach ($lista as $obj) {
            ...
            $hidden_objeto = "<input type='hidden' id='".$obj->id."_objeto' value='" . $obj->objeto."'>";
            if($obj->excluir){
                echo "  <td align='center'>". $hidden_objeto . "<button class='btn btn-primary btn-sm' type='button' onclick='alterar(".$obj->id.",\"".$obj->modalidade."\",\"".$obj->certame."\",\"".$obj->ano."\")'><i class='fas fa-edit'></i></button>&nbsp;&nbsp;<button class='btn btn-danger btn-sm' type='button' onclick='excluir(".$obj->id.",\"".$obj->modalidade."\",\"".$obj->certame."\")'><i class='far fa-trash-alt'></i></button>".$btn_arquivos."</td>";
            } else {
                echo "  <td align='center'>". $hidden_objeto . "<button class='btn btn-primary btn-sm' type='button' onclick='alterar(".$obj->id.",\"".$obj->modalidade."\",\"".$obj->certame."\",\"".$obj->ano."\")'><i class='fas fa-edit'></i></button>&nbsp;&nbsp;<button class='btn btn-secondary btn-sm' type='button' title='Possuí dependências!'><i class='far fa-trash-alt' alt='Possuí dependências!'></i></button>".$btn_arquivos."</td>";                
            }
            echo "</tr>";
        }
