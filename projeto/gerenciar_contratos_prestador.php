            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    if (isset($_REQUEST['id'])) {
                        ...
                        $prestador->contratos = $manterPrestador->getContratosPorId($id_prestador);
                        $editar = false;
                        ...
                        <div class="card mb-4 border-primary" style="max-width:800px">
                            <div class="row ml-0 card-header py-2 bg-gradient-primary" style="width:100%">
                                ...
                                <div class="col mb-0">
                                    <span style="align:left;" class="h5 m-0 font-weight text-white">Contratos do prestador</span>
                                </div>
                            </div>                            
                            ...
                            <div class="card-body">
                                <table id="acessos" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%">
                                    ...
                                    <tbody id="fila">
                                        <?php include './get_contratos_prestador.php'; ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
