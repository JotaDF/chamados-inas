<?php
        ...
        foreach ($ocorrencias as $obj) {
            ...
            if($obj->ativo == 1){
                $txt_status = "<a title='Marcar como não resolvida!' href='mudar_status_ocorrencia_nota.php?id=".$obj->id."&id_nota=".$id_nota."&id_prestador=".$prestador->id."&tp=".$tp."&status=0' class='btn btn-warning btn-sm' ><i class='fa fa-exchange'></i></a>";
            }
