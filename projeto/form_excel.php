        ...
        <div class="card-body ">
            <div class="row g-3">
                <div class="col">
                    ...
                    <input class="form-control" type="file" name="excel" id="excel" accept=".xlsx, .xls, .xlt"
                        required>
                </div>
                <div class="col">
            ...
            <div class="row g-3">
                ...
                <div class="col">
                    <div class="mb-2">
                        ...
                        <select class="form-select" name="procEmi" id="retificacao2" aria-label="Default select example">
                            <option selected></option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                        </select>
            ...
            <div class="mb-3">
                <button type="submit" name="envio" class="btn btn-primary btn-sm">Converter XML</button>&nbsp&nbsp
                <button type="submit" name="baixar" class="btn btn-secondary btn-sm">
                   Baixar XML&nbsp&nbsp&nbsp<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-bar-down" viewBox="0 0 16 16">
