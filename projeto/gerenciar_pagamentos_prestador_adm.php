...
<html>
    ...
    <body id="page-top">
        ...
        <!-- Page Wrapper -->
        <div id="wrapper">
            <?php include './menu_execucao_adm.php'; ?>
            <!-- Content Wrapper -->
                                        ...
                                        <?php 
                                                foreach ($pagamentos as $obj) {
                                                    ...
                                                    foreach ($notas as $n) {
                                                        ...
                                                        $btn_nt_executar = "<a class='btn btn-primary btn-sm' title='Executar nota!' href='executar_nota_pagamento.php?adm=1&id_prestador=".$prestador->id."&id=".$n->id."&id_usuario=".$usuario_logado->id."'><i class='fa fa-play'></i></a>";
                                                        $btn_nt_reverter_exec = "<a class='btn btn-danger btn-sm' title='Reverter execução!' href='reverter_execucao_nota_pagamento.php?adm=1&id_prestador=".$prestador->id."&id=".$n->id."&id_usuario=".$usuario_logado->id."'><i class='fa fa-random'></i></a>&nbsp;";
                                                        $btn_nt_reverter_atst = "<a class='btn btn-danger btn-sm' title='Reverter atesto!' href='reverter_atesto_nota_pagamento.php?adm=1&id_prestador=".$prestador->id."&id=".$n->id."&id_usuario=".$usuario_logado->id."'><i class='fa fa-random'></i></a>&nbsp;";
                                                        $btn_nt_reverter_pag = "<a class='btn btn-danger btn-sm' title='Reverter pagamento!' href='reverter_pagamento_nota_pagamento.php?adm=1&id_prestador=".$prestador->id."&id=".$n->id."&id_usuario=".$usuario_logado->id."'><i class='fa fa-random'></i></a>&nbsp;";
                                                        $btn_nt_atestar = "<a class='btn btn-success btn-sm' title='Atestar nota!' href='atestar_nota_pagamento.php?adm=1&id_prestador=".$prestador->id."&id=".$n->id."&id_usuario=".$usuario_logado->id."'><i class='fa fa-check'></i></a>";                                                    
                                                        ...
                                                        $btn_nt_alterar = "<button title='Alterar nota!' class='btn btn-primary btn-sm' type='button' onclick='alterarNota(".$obj->id.",\"".$obj->competencia."\",\"".$obj->informativo."\",".$prestador->id.",".$n->id.",\"".$n->numero."\",\"".$n->valor."\",\"".$n->exercicio."\",".$usuario_logado->id.",\"".date('Y-m-d', $n->data_emissao)."\",\"".date('Y-m-d', $n->data_validacao)."\")'><i class='fas fa-edit text-white'></i></button>";                                                
                                                        $txt_btns = " - ";
                                                        $txt_doc_sei = "";
                                                        if($editar){
                                                            $txt_btns = "";
