...
foreach ($objetivo as $o) {
    ...
    $btn_excluir = "<button type='button' class='btn btn-danger btn-sm'  title='Excluir: $o->descricao' onclick='excluir(\"" . $o->id . "\",\"" . $o->descricao . "\",".$id_planejamento.")'><i class='far fa-trash-alt'></i></button>";
    echo "<tr>";
    echo "<td>" . $o->id . "</td>";
