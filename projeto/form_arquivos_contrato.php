...
<html>
    <head>
        ...
        <title>Enviar arquivos ponto</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4 border-primary" style="max-width:900px">
                            <div class="row ml-0 card-header py-2 bg-gradient-primary" style="width:100%">
                                ...
                                <div class="col mb-0">
                                    <span style="align:left;" class="h5 m-0 font-weight text-white">Enviar arquivos do contrato (<?=$numero . '/' . $ano ?>)</span>
                                </div>
                                <div class="col text-right" style="max-width:20%">
                                    <a id="btn_cadastrar" title="Visualizar diretório" class="btn btn-outline-light btn-sm" href="gerenciar_arquivos_contrato.php?numero=<?=$numero ?>&ano=<?=$ano ?>" >
