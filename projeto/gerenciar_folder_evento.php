...
<html>
    <head>
        ...
        <title>Gerenciar folder evento</title>
        ...
        <script type="text/javascript" class="init">
             function deleteFile(fileName) {
                ...
                xhr.open("GET", "del_arquivo_evento.php?numero=<?=$numero ?>&ano=<?=$ano ?>&file=" + fileName, true);
            ...
            function atualizar(){
                ...
                $.ajax({
                    url: 'get_folder_evento.php?id=<?=$id ?>',
                    dataType: 'html',
                    success: function (html) {
                        $('#arquivos_evento').html(html);
                    }
                });
            }
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div style="max-width:900px" class="row float-none">
                        ...
                        <!-- Collapsable Form -->
                        <div class="card mb-4 collapse hide border-primary" id="form_arquivos_evento" style="max-width:900px">
                            <!-- Card Header - Accordion -->
                            <div class="card-header py-2 card-body bg-gradient-primary align-middle" style="min-height: 2.5rem;">               
                                <span class="h6 m-0 font-weight text-white">Enviar arquivos do evento (<?='folder_' . $id ?>)</span>
                            </div>                  
                            ...
                            <div class="form-group row float-right">
                                <button type="reset" data-toggle="collapse" data-target="#form_arquivos_evento" class="btn btn-danger btn-sm"><i class="fa fa-minus-square"></i> Cancelar</button>
                            </div>
                        </div>
                        </div>
                        ...
                        <?php
                            ...
                            if (isset($_REQUEST['id'])) {
                                $evento    = $manterEvento->getEventoPorId($_REQUEST['id']);
                            }
                            ?>
                        ...
                        <div class="card mb-4 border-primary" style="max-width:900px">
                            <div class="row ml-0 card-header py-2 bg-gradient-primary" style="width:100%">
                                ...
                                <div class="col mb-0">
                                    <span style="align:left;" class="h5 m-0 font-weight text-white">Folder do evento </span> <button class='btn btn-outline-light btn-sm' type='button' title="Atualizar lista!" onclick="atualizar()"><i class="fa fa-spinner text-white" aria-hidden="true"></i></button>
                                </div>
                                <div class="col text-right" style="max-width:20%">
                                    <button id="btn_cadastrar" class="btn btn-outline-light btn-sm" type="button" data-toggle="collapse" data-target="#form_arquivos_evento" aria-expanded="false" aria-controls="form_arquivos_evento">
                                        <i class="fa fa-plus-circle text-white" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>                            
                            <div class="card-body">
                                <div class="card-group" id="arquivos_evento">
                                    <?php
