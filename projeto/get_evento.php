<?php
	...
	$lista = $manterEvento->listar();
        ...
        foreach ($lista as $obj) {
            ...
            $btn_alterar = $hidden_descricao . "<button class='btn btn-primary btn-sm' type='button' onclick='alterar(".$obj->id.",\"".$obj->titulo."\",\"".$obj->inscreve."\",\"".$obj->data."\",\"".$obj->hora."\")'><i class='fas fa-edit'></i></button>";
            if($obj->excluir){
                echo "  <td align='center'>" . $btn_alterar . "&nbsp;&nbsp;<button class='btn btn-danger btn-sm' type='button' onclick='excluir(".$obj->id.",\"".$obj->titulo."\")'><i class='far fa-trash-alt'></i></button>" . $btn_inscricoes . $btn_folder .  "</td>";
            } else {
