...
<html>
    <head>
        ...
        <title>Gerenciar Arquivo Ofício</title>
        ...
        <script type="text/javascript" class="init">
             function deleteFile(fileName) {
                ...
                xhr.open("GET", "del_arquivo_oficio.php?id=<?=$id ?>&file=" + fileName, true);
                    ...
                    <div style="max-width:900px" class="row float-none">
                        ...
                        <div class="card mb-4 collapse border-primary" id="form_arquivo_oficio" style="max-width:900px">
                            ...
                            <div class="form-group row float-right">
                                <button type="reset" data-toggle="collapse" data-target="#form_arquivo_oficio" class="btn btn-danger btn-sm"><i class="fa fa-minus-square"></i> Cancelar</button>
                            </div>
                        </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="c1 ml-4">
                                        ...
                                        <div class="mb-0"><?=$oficio->processo ?></div>
                                    </div>
                                    <div class="c2 ml-4">
                                        <div class="text-xs font-weight-bold text-uppercase mb-1">Assunto:</div>
                                        <div class="mb-0"><?=$oficio->assunto ?></div>
                                    </div> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4 border-primary" style="max-width:900px">
                            ...
                            <div class="card-body">
                                <div class="card-group" id="arquivo_oficio">
                                    <?php
