...
<head>
    ...
    <script type="text/javascript" class="init">
        ...
        function excluir(id, descricao) {
            $('#delete').attr('href', 'del_medico_perito.php?id=' + id);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <?php include './form_medico_perito.php'; ?>
                    <div class="card mb-4 border-primary" style="max-width:900px">
                        <div class="row ml-0 card-header py-2 bg-gradient-primary" style="width:100%">
                            ...
                            <div class="col mb-0">
                                <span style="align:left;" class="h5 m-0 font-weight text-white">Médicos</span>
                            </div>
                            <div class="col text-right" style="max-width:20%">
                                <button id="btn_cadastrar" class="btn btn-outline-light btn-sm" type="button"
                                    data-toggle="collapse" data-target="#form_medico_perito" aria-expanded="false"
                                    aria-controls="form_medico_perito">
                                    <i class="fa fa-plus-circle text-white" aria-hidden="true"></i>
                                </button>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="medicos" class="table-sm table-striped table-bordered dt-responsive wrap"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th scope="col">ID</th>
                                ...
                                <tbody>
                                    <?php include('./get_medico_perito.php'); ?>
                                </tbody>
                            </table>
                        </div>
                    </div>
