        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div id="tab_ano" class="row d-flex justify-content-center">             
                    ...
                    <div id="tab_ano_mes" class="row d-flex justify-content-center">
                    ...
                    <div id="tab_assunto" class="row d-flex justify-content-center">
                        <!-- Primeiro Card (Gráfico de Barras) -->
                        <div class="w-100">                            
                    ...
                    <div id="tab_motivo" class="row d-flex justify-content-center">
                        <!-- Primeiro Card (Gráfico de Barras) -->
                        <div class="w-100">                            
