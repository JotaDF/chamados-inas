<?php
        ...
        foreach ($prestador->executores as $obj) {
            ...
            $btn_ativar = "";
            $txt_status = "<a title='Ativar' href='mudar_status_executor.php?id_usuario=".$obj->id."&id_prestador=".$prestador->id."&status=1' ><img src='./img/nao_visivel.svg' width='30'/></a>";
            if($obj->ativo == 1){
                $txt_status = "<a title='Desativar' href='mudar_status_executor.php?id_usuario=".$obj->id."&id_prestador=".$prestador->id."&status=0' ><img src='./img/visivel.svg' width='30'/></a>";
            }
