...
=======
        foreach ($lista as $obj) {
            ...
            $hidden_observacao = "<input type='hidden' id='".$obj->id."_observacoes' value='".htmlspecialchars($obj->observacao, ENT_QUOTES)."'>";
