<?php
	...
	$lista = $manterProcesso->listar();
        ...
        foreach ($lista as $obj) {
            ...
            echo "  <td>".date('Y-m-d', $obj->autuacao)."</td>";
            echo "  <td>".date('Y-m-d', strtotime($obj->atualizacao))."</td>";
