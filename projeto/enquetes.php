...
<head>
    ...
    <script type="text/javascript" class="init">
        ...
        $(document).ready(function () {
            ...
            document.getElementById('form_enquete').addEventListener('submit', function () {
                var descricaoHTML = quillEditor.root.innerHTML;
                console.log(document.querySelector('input[name="descricao"]').value = descricaoHTML);
            });
        });

        function excluir(id, nome) {
            $('#delete').attr('href', 'del_enquete.php?id=' + id);
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4 border-primary" style="max-width:1200px">
                        <div class="row ml-0 card-header py-2 bg-gradient-primary" style="width:100%">
                            ...
                            <div class="col mb-0">
                                <span style="align:left;" class="h5 m-0 font-weight text-white">Enquetes</span>
                            </div>
                            <div class="col text-right" style="max-width:20%">
                                <button id="btn_cadastrar" class="btn btn-outline-light btn-sm" type="button"
                                    data-toggle="collapse" data-target="#form_enquete" aria-expanded="false"
                                    aria-controls="form_enquete">
                                    <i class="fa fa-plus-circle text-white" aria-hidden="true"></i>
                                </button>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="enquetes" class="table-sm table-striped table-bordered dt-responsive"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th scope="col">ID</th>
