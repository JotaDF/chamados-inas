    ...
    <head>
        ...
        <script type="text/javascript" class="init">
            ...
            $(document).ready(function () {
                $('#sub_assuntos').DataTable();
            });
            function excluir(id, sub_assunto) {
                $('#delete').attr('href', 'del_sub_assunto.php?id=' + id);
                $('#excluir').text(sub_assunto);
                $('#confirm').modal({show: true});              
            }
            function alterar(id, sub_assunto) {
                $('#id').val(id);
                $('#sub_assunto').val(sub_assunto);
                $('#form_sub_assunto').collapse("show");
                $('#btn_cadastrar').hide();
            }
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <?php include './form_sub_assunto.php'; ?>
                        ...
                        <div class="card mb-4 border-primary" style="max-width:900px">
                            ...
                            <div class="card-body">
                                <table id="sub_assuntos" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th scope="col">ID</th>
                                    ...
                                    <tbody>
                                        <?php include './get_sub_assunto.php'; ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
