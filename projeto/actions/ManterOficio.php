...
class ManterOficio extends Model {
    ...
    function salvar(Oficio $dados) {
        $sql = "insert into oficio (processo, link_sei, numero, assunto, destino, origem, enviado, atendido, setor, arquivo, id_usuario) values ('" . $dados->processo . "','" . $dados->link_sei . "','" . $dados->numero . "','" . $dados->assunto . "','" . $dados->destino . "','" . $dados->origem . "','" . $dados->enviado . "','" . $dados->atendido . "','" . $dados->setor . "','" . $dados->arquivo . "','" . $dados->usuario . "')";
        //echo $sql . "<BR/>";
        if ($dados->id > 0) {
